...
<script>
      ...
      $(document).ready(function(){
        // Establecer variables de activación y contenedor
        var trigger = $('.container .display-chat '),
            container = $('#content');
        
        // Fuego al hacer clic
        trigger.on('click', function(){
          // Establecer destino a partir del atributo de datos
          var $this = $(this),
            target = $this.data('target');       
          
          // Cargar la página de destino en el contenedor
          container.load(target + '.php');
          
          // Detener el comportamiento normal del enlace
          return false;
        });
      });
    </script>
